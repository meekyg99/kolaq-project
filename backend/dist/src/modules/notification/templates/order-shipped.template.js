...
function orderShippedTemplate(data) {
  ...
  `;
    return (0, base_template_1.getBaseTemplate)(content, `Your KOLAQ ALAGBO order #${data.orderNumber} has shipped! Track your package now.`);
}
//# sourceMappingURL=order-shipped.template.js.map