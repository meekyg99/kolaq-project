...
<head>
  ...
  <title>Order Confirmation - KOLAQ Bitters</title>
</head>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="background: white; padding: 30px; border: 1px solid #e0e0e0; border-top: none; border-radius: 0 0 10px 10px;">
    ...
    <div style="background: #f8f9fa; padding: 15px; border-radius: 8px; margin: 20px 0;">
      ...
      <p style="margin: 5px 0 0 0; font-size: 20px; font-weight: bold; color: #667eea;">${data.orderNumber}</p>
    </div>

    <h2 style="border-bottom: 2px solid #667eea; padding-bottom: 10px; margin-top: 30px;">Order Details</h2>
    ...
    <div style="text-align: right; margin-top: 20px;">
      ...
      <p style="margin: 15px 0 0 0; font-size: 18px; padding-top: 10px; border-top: 2px solid #667eea;">
        Total: <strong style="color: #667eea;">${data.currency} ${data.total.toFixed(2)}</strong>
      </p>
    </div>
    ...
    <div style="margin-top: 30px; padding: 20px; background: #e8f4f8; border-left: 4px solid #667eea; border-radius: 4px;">
    ...
    <div style="margin-top: 30px; text-align: center; color: #666; font-size: 14px;">
      <p>Need help? Contact us at <a href="mailto:support@kolaqbitters.com" style="color: #667eea;">support@kolaqbitters.com</a></p>
