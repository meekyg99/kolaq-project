...
export default function CartPage() {
  ...
  return (
    <div className="container grid gap-12 py-12 lg:grid-cols-[2fr_1fr]">
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          {items.map(({ product, quantity }) => (
            <div
              key={product.id}
              className="flex flex-col gap-4 rounded-[24px] border border-slate-200 bg-white p-6 shadow-sm sm:flex-row sm:items-center"
            >
              ...
              <div className="flex flex-1 items-center justify-end gap-6 sm:flex-col sm:items-end">
                <div className="flex items-center gap-4">
                  <button
                    type="button"
      ...
      <aside className="space-y-6 rounded-[28px] border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <Link
          href="/checkout"
          className="inline-flex w-full items-center justify-center rounded-full bg-[var(--accent)] px-6 py-3 text-sm font-semibold uppercase tracking-[0.4em] text-white transition hover:bg-emerald-500"
        >
          Proceed to Checkout
        </Link>
